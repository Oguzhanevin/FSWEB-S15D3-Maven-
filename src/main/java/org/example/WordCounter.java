...
public class WordCounter {
    ...
    // Kelimeleri sayan method
    public static Map<String, Integer> calculateWord(String text) {
        // Texti küçük harfe dönüştürüp boşluklardan ayırıyoruz
        String[] words = text.toLowerCase().split("\\W+");

        // Kelimeleri saymak için bir Map kullanıyoruz
        Map<String, Integer> wordCountMap = new HashMap<>();

        // Her bir kelimeyi kontrol ediyoruz
        for (String word : words) {
            // Boş kelimeleri geçiyoruz
            if (!word.isEmpty()) {
